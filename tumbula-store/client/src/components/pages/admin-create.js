...
class AdminCreateBody extends React.Component{
    ...
    async handleStoreCreation(event)
        {
            ...
            if (typeof this.state.storeInstance !== 'undefined') {
                ...
                let result = await this.state.storeInstance.methods.addAdmin(this.state.address).send({ from: this.state.account})
        ...
        return(
            <div className="main-panel">
                <div className="content-wrapper">
                    <HeadBannerComponent
                        bannerHead={"Admin Creation"}
                        bannerWords={"Add admins to the Application"}
                        // headButton={"Add New Store"}
                        >
                    </HeadBannerComponent>
                    <FormOuterComponent
                        formTitle={"Admin Creation Form"}
                    ...
                    >
                        <form className="form-sample" onSubmit={this.handleStoreCreation}>
                            <div className="row">
                                <FormMinorComponent
                                    label={"Address"}
                                    placeHolder={"Please Enter Address of admin"}
                                    name={"address"}
...
export default withRouter(AdminCreateBody);